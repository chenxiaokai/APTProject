...
public class FactoryProcessor extends AbstractProcessor{
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        try {
            for (Element annotatedElement : roundEnv.getElementsAnnotatedWith(Factory.class)) {
                ...
                System.out.println("-----------> name = "+annotatedElement.getSimpleName()+"  kind = "+annotatedElement.getKind() + "  type = "+annotatedElement.getClass().getName());
                //-----------> name = TiramisuPizza  kind = CLASS  type = com.sun.tools.javac.code.Symbol$ClassSymbol
                //-----------> name = MargheritaPizza  kind = CLASS  type = com.sun.tools.javac.code.Symbol$ClassSymbol
                //-----------> name = CalzonePizza  kind = CLASS  type = com.sun.tools.javac.code.Symbol$ClassSymbol
    ...
    //我们要检查被注解的类至少有一个公有构造函数，不是抽象类，继承了特定的类，以及是一个public类
